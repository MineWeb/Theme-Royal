...
<section class="content">
    ...
    <div class="col-md-4">
        <div class="callout callout-danger" style="border: none;"><h4>Copyright : Mineweb & Royal</h4>Il est interdit de modifier les crédits du footer.<br>Vous n'aurez plus de support et vous serez bannis du discord si vous le faites.</div>
    </div>
    <div class="row">
